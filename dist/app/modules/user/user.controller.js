...
const getAllUsers = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.UserService.getAllUsers(req.query, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const manageRole = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.UserService.manageRole(req.body, req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
